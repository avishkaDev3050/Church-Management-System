...
public class AddEmpAddress extends javax.swing.JFrame {

    private String emp_id;
    private static HashMap<String, String> empCityMap = new HashMap<>();

    public AddEmpAddress(String fname, String lname, String emp_id) {
        initComponents();
        lbl_employee.setText(fname + " " + lname);
        this.emp_id = emp_id;
        loadAddress();
        loadCities();

        ImageIcon icon = new ImageIcon(AddAddress.class.getResource("/resources/logo.png"));
    ...
    private void loadCities() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                empCityMap.put(resultSet.getString("city"), resultSet.getString("id"));
            }
    ...
    private void initComponents() {
        ...
        lbl_employee.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(lbl_employee, javax.swing.GroupLayout.PREFERRED_SIZE, 401, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbl_employee, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(23, 23, 23)
        ...
        if (line1.isEmpty()) {
            ...
            if (!isFound) {
                ...
                try {
                    ...
                    MySQL.execute("INSERT INTO `employee_address`(`employee_id`, `line_1`,`line_2`,`city_id`)"
                            + "VALUES ('" + this.emp_id + "','" + line1 + "','" + line2 + "','" + empCityMap.get(city) + "')");
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        ...
        if (line1.isEmpty()) {
            ...
            if (!isFound) {
                ...
                try {
                    MySQL.execute("UPDATE `employee_address` SET `line_1`='" + line1 + "',`line_2`='" + line2 + "',`city_id`='" + empCityMap.get(city) + "'"
                            + "WHERE `id`='" + id + "'");
